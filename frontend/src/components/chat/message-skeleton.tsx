      ...
      <div className="flex-1 w-full space-y-3">
        ...
        {message && (
          <div className="flex items-center gap-2 text-sm text-gray-500 dark:text-gray-400">
            ...
            {type === 'default' && <Loader2 className="w-4 h-4 animate-spin" />}
            <span>{message}</span>
          </div>
        )}
        ...
        <div className="space-y-2">
          <div className="h-4 bg-gray-200 dark:bg-gray-700 rounded-md animate-pulse" style={{ width: '85%' }} />
          <div className="h-4 bg-gray-200 dark:bg-gray-700 rounded-md animate-pulse" style={{ width: '95%' }} />
          <div className="h-4 bg-gray-200 dark:bg-gray-700 rounded-md animate-pulse" style={{ width: '75%' }} />
          <div className="h-4 bg-gray-200 dark:bg-gray-700 rounded-md animate-pulse" style={{ width: '90%' }} />
        </div>
          ...
          {[1, 2, 3].map((i) => (
            <div key={i} className="flex gap-3 p-3 rounded-lg bg-gray-50 dark:bg-gray-800/50 border border-gray-200 dark:border-gray-700">
              ...
              <div className="flex-1 space-y-1">
                <div className="h-3.5 bg-gray-200 dark:bg-gray-700 rounded-md animate-pulse" style={{ width: '80%' }} />
                <div className="h-3 bg-gray-200 dark:bg-gray-700 rounded-md animate-pulse" style={{ width: '95%' }} />
                <div className="h-3 bg-gray-200 dark:bg-gray-700 rounded-md animate-pulse w-full" style={{ width: '100%' }} />
              </div>
