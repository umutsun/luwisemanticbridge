...
export default function PinokyoProductPage() {
  return (
    <div className="min-h-screen bg-gradient-to-b from-sky-50 to-white text-slate-800">
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <motion.nav
          ...
          className="text-sm text-slate-600 flex items-center gap-2 mb-6"
        >
          <a href="/wireframe" className="hover:text-sky-700">Ana Sayfa</a>
        ...
        {/* Product Block */}
        <section className="grid md:grid-cols-2 gap-10 items-start mb-12">
          <motion.div
            initial={{ opacity: 0, y: 10 }}
            animate={{ opacity: 1, y: 0 }}
        ...
        <section className="mb-12">
          <div className="flex items-center justify-between mb-4">
            ...
            <a className="text-sky-700 text-sm" href="#">Tümünü Gör</a>
          </div>
