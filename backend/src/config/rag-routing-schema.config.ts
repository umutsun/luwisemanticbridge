      ...
      format: {
        ...
        articleSections: [
          ...
          },
          {
            ...
            required: true,
            systemGenerated: true,  // Backend üretir (sources metadata'dan)
            description: 'Sistem tarafından kaynak içeriğinden regex ile çıkarılır.',
            descriptionEn: 'Automatically extracted from source content using regex patterns.'
          },
          {
            id: 'assessment',
            title: 'Değerlendirme',
            ...
            required: true,
            systemGenerated: false,  // LLM yazar
            description: 'Akademik makale formatında detaylı analiz yaz. Kaynaklardaki bilgileri sentezle, karşılaştır, değerlendir. Her paragraf farklı bir perspektif veya alt konu ele alsın. Uzunluk ayarlardan belirlenir.',
            descriptionEn: 'Write a detailed analysis in academic article format. Synthesize, compare, and evaluate information from sources. Each paragraph should address a different perspective or subtopic. Length is determined by settings.'
          }
        ],
